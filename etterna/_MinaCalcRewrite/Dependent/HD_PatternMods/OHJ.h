...
#pragma region params
	...
	float min_mod = 0.745697F;
	float max_mod = 1.01753F;

	float max_seq_weight = 0.628181F;
	float max_seq_pool = 1.12848F;
	float max_seq_scaler = 2.05379F;

	float prop_pool = 1.49079F;
	float prop_scaler = 1.01386F;
...
#pragma endregion
	...
	void set_max_seq_comp()
	{
		...
		max_seq_component = max_seq_component < 0.0974054F ? 0.0974054F : max_seq_component;
	...
	void set_prop_comp()
	{
		...
		prop_component = prop_component < 0.0916904F ? 0.0916904F : prop_component;
